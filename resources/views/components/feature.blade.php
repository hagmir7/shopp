<div class="max-w-7xl mx-auto py-8">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="flex flex-col items-center p-6 bg-white rounded-lg shadow-sm">
            ...
            <h2 class="text-lg font-semibold mb-2">Superfast Delivery</h2>
            <p class="text-gray-600 text-center">Free 48-hour delivery</p>
        </div>
        ...
        <div class="flex flex-col items-center p-6 bg-white rounded-lg shadow-sm">
            ...
            <h2 class="text-lg font-semibold mb-2">Warehouse to Door</h2>
            <p class="text-gray-600 text-center">Direct Savings Guaranteed</p>
        </div>
        ...
        <div class="flex flex-col items-center p-6 bg-white rounded-lg shadow-sm">
            ...
            <h2 class="text-lg font-semibold mb-2">Instant Live Support</h2>
            <p class="text-gray-600 text-center">Available 8am - 8pm (UK Time)</p>
        </div>
        ...
        <div class="flex flex-col items-center p-6 bg-white rounded-lg shadow-sm">
            ...
            <h2 class="text-lg font-semibold mb-2">Hassle-Free Returns</h2>
            <p class="text-gray-600 text-center">Return items within 28 days!</p>
        </div>
    </div>
</div>
