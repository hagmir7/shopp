<div x-data="{modalIsOpen: false}" class="rounded-full bg-[#efeeeb]">
    <!-- Button to open the modal with aria-label for accessibility -->
    <button @click="modalIsOpen = true" type="button" class="hover:text-gray-600 p-2 rounded-full bg-[#efeeeb] border-primary border-2"
    ...
    <!-- Modal with appropriate ARIA roles and attributes -->
    <div x-cloak x-show="modalIsOpen" x-transition.opacity.duration.200ms @keydown.esc.window="modalIsOpen = false"
        ...
        role="dialog" aria-modal="true" aria-labelledby="defaultModalTitle" aria-hidden="true">
        <!-- Modal Dialog -->
