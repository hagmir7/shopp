<nav class="fixed lg:hidden bottom-0 z-50 left-0 right-0 w-full bg-white border-t border-gray-300 shadow-md rounded-t-xl">
    ...
    <div class="flex justify-around items-center py-2">
        ...
        <!-- My Account -->
        <a href="{{ route("menu") }}" class="flex flex-col items-center justify-center text-gray-600 hover:text-black">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mb-1" viewBox="0 0 24 24">
                <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
