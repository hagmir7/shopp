    ...
    <div class="container mx-auto flex flex-wrap items-center justify-between px-4 py-4">
        ...
        <div class="flex-1 max-w-xl mx-4 hidden lg:block">
            <div class="relative">
                ...
                <input type="text" placeholder="{{ __("Search for products") }}" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-gray-200">
            </div>
        </div>
