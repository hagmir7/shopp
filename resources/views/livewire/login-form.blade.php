<form class="" wire:submit.prevent='login()'>
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="#!" class="text-sm font-medium text-red-600 hover:underline">{{ __("Mot de passe oublié ?") }}</a>
    </div>
    ...
    <button type="submit"
        class="text-white w-full bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2">
