...
<div class="flex flex-col justify-center">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p class="mt-2 text-center text-md text-slate-700">
            {{ __("You can now enter your new password to reset it") }}
        </p>
    </div>
        ...
        <div class="py-8 px-4 shadow sm:rounded-lg sm:px-10 bg-white">
            ...
            <form wire:submit.prevent="resetPassword">
                <div class="mt-2">
                    ...
                    <input
                        class="appearance-none block w-full px-3 py-2 border-2 border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm"
                ...
                <div class="mt-2">
                    ...
                    <input
                        class="appearance-none block w-full px-3 py-2 border-2 border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm"
                        type="password" id="password" wire:model="password" required>
                ...
                <div class="mt-2">
                    ...
                    <input
                        class="appearance-none block w-full px-3 py-2 border-2 border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm"
                        type="password" id="password_confirmation" wire:model="password_confirmation" required>
                </div>
                ...
                <div class="mt-3">
                    <button type="submit" class="w-full btn btn-primary rounded-lg">
                        <svg wire:loading aria-hidden="true" role="status"
                            class="inline w-4 h-4 me-3 text-red animate-spin" viewBox="0 0 100 101" fill="none"
