<form action="#" class="space-y-4">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
            ...
            <input wire:model='full_name' class="w-full p-3 text-sm border-gray-200 rounded-lg"
                placeholder="Nom et Prénom" type="text" id="full_name" full_name="name">
            <!-- Error area -->
            @error('full_name')
        ...
        <div>
            ...
            <input wire:model='email' class="w-full p-3 text-sm border-gray-200 rounded-lg" placeholder="Adresse e-mail"
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
            ...
            <input wire:model='phone' class="w-full p-3 text-sm border-gray-200 rounded-lg"
                placeholder="Numéro de téléphone" type="tel" id="phone" name="phone">
            <!-- Error area -->
            @error('phone')
            <span class="text-white text-sm">{{ $message }}</span>
            @enderror
        ...
        <div>
            ...
            <input wire:model='subject' class="w-full p-3 text-sm border-gray-200 rounded-lg" placeholder="Sujet"
    ...
    <div>
        ...
        <textarea wire:model='message' class="w-full p-3 text-sm border-gray-200 rounded-lg" placeholder="Message"
            rows="8" id="message" name="message"></textarea>
        <!-- Error area -->
        @error('message')
        <span class="text-white text-sm">{{ $message }}</span>
        @enderror
